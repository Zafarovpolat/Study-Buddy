...
class PresentationService:
    ...
    async def generate_presentation_structure(
        self, topic: str, num_slides: int = 10, style: str = "professional"
    ) -> Dict[str, Any]:
...
Верни ТОЛЬКО валидный JSON!"""
        ...
        try:
            ...
            structure = parse_ai_json_response(text)
        ...
        return {
            ...
            "slides": [
                ...
                },
                {
                    "type": "conclusion",
                    "title": "Заключение",
                    "bullets": ["Ключевые выводы", "Практическое применение"],
                    "call_to_action": "Изучите тему подробнее!",
                },
            ],
        }

    def create_pptx(self, structure: Dict[str, Any], theme: str = "blue") -> BytesIO:
    ...
    def _add_title_slide(self, prs, data: Dict, colors: Dict):
        ...
        title_box = slide.shapes.add_textbox(
            Inches(0.5), Inches(2.7), Inches(12.333), Inches(1.2)
        )
        ...
        if data.get("subtitle"):
            subtitle_box = slide.shapes.add_textbox(
                Inches(0.5), Inches(4), Inches(12.333), Inches(0.8)
            )
    ...
    def _add_two_column_slide(self, prs, data: Dict, colors: Dict):
        ...
        left_title = slide.shapes.add_textbox(
            Inches(0.5), Inches(1.5), Inches(6), Inches(0.6)
        )
        ...
        divider = slide.shapes.add_shape(
            MSO_SHAPE.RECTANGLE, Inches(6.5), Inches(1.5), Inches(0.05), Inches(5.5)
        )
        divider.fill.solid()
        ...
        right_title = slide.shapes.add_textbox(
            Inches(6.833), Inches(1.5), Inches(6), Inches(0.6)
        )
        ...
        right_content = slide.shapes.add_textbox(
            Inches(6.833), Inches(2.2), Inches(6), Inches(4.5)
        )
    ...
    def _add_quote_slide(self, prs, data: Dict, colors: Dict):
        ...
        quote_box = slide.shapes.add_textbox(
            Inches(1.5), Inches(2.5), Inches(10.333), Inches(3)
        )
        ...
        if data.get("author"):
            author_box = slide.shapes.add_textbox(
                Inches(1.5), Inches(5.5), Inches(10.333), Inches(0.8)
            )
    ...
    def _add_conclusion_slide(self, prs, data: Dict, colors: Dict):
        ...
        if data.get("call_to_action"):
            cta_box = slide.shapes.add_textbox(
                Inches(0.5), Inches(6), Inches(12.333), Inches(1)
            )
