...
class UserService:
    ...
    async def get_streak_info(self, user: User) -> dict:
        ...
        return {
            ...
            "last_activity": user.last_activity_date.isoformat()
            if user.last_activity_date
            else None,
    ...
    async def get_limits_info(self, user: User) -> dict:
        ...
        return {
            ...
            "limits": {
                ...
                if user.max_members_per_group < 999999
                else None,
                "max_materials_per_group": user.max_materials_per_group
                if user.max_materials_per_group < 999999
                else None,
